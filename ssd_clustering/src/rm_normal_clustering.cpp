#include <ssd_clustering/rm_normal_clustering.h>
...
{
    ros::init(argc, argv, "rm_normal_clustering");
    ros::NodeHandle n;

    ros::Subscriber sub = n.subscribe("/velodyne/rm_normal", 10, pcCallback);

    pub_bbox = n.advertise<jsk_recognition_msgs::BoundingBoxArray>("/rm_normal/clustering", 10);
    pub_cluster = n.advertise<ssd_ros_msgs::ClusterArray>("/cluster", 10);
